...
namespace USEPA_Simulation_PlugIns
{
    ...
    public abstract class CapeUserException : System.ApplicationException,
        USEPA_Simulation_PlugIns.ECapeRoot,
        USEPA_Simulation_PlugIns.ECapeUser
    {
        ...
        /// should include a reference to the previous exception in the InnerException 
        /// property. The InnerException property returns the same value that is passed 
        /// into the constructor, or a null reference if the InnerException property does 
        ...
        /// <summary>
        /// A virtual abstract function that is inherited by derived classes to 
        ...
        //    //catidKey.CreateSubKey(COGuids.USEPA_Simulation_PlugInsComponent_CATID);
        ...
        /// </summary>
        /// <remarks>
        /// This field provides the name of the operation being performed when the exception was raised.
        /// </remarks>
    ...
    /// and information on license key.	
    /// </para>
    /// </remarks>
    [Serializable]
        ...
        USEPA_Simulation_PlugIns.ECapeBadCOParameter
    {
        ...
        protected void Initialize(String parameterName, Object pParameter)
        {
            ...
            m_Parameter = (USEPA_Simulation_PlugIns.ICapeParameter)(parameter);
    ...
    /// </summary>
    /// <remarks>
    /// <para>CapeBoundariesException is a "utility" class which factories a state which describes the value, its type and its boundaries.</para>
    ...
    /// <see c = "CapeFailedInitialisationException">USEPA_Simulation_PlugIns.CapeFailedInitialisationException</see>, 
    /// <see c = "CapeOutOfResourcesException">USEPA_Simulation_PlugIns.CapeOutOfResourcesException</see>, 
    /// <see c = "CapeSolvingErrorException">USEPA_Simulation_PlugIns.CapeSolvingErrorException</see>, 
    /// <see c = "CapeBadInvOrderException">USEPA_Simulation_PlugIns.CapeBadInvOrderException</see>, 
    /// <see c = "CapeInvalidOperationException">USEPA_Simulation_PlugIns.CapeInvalidOperationException</see>, 
    /// <see c = "CapeNoMemoryException">USEPA_Simulation_PlugIns.CapeNoMemoryException</see>, and 
    /// <see c = "CapeTimeOutException">USEPA_Simulation_PlugIns.CapeTimeOutException</see> 
    ...
    /// <see c = "CapeNoImplException ">USEPA_Simulation_PlugIns.CapeNoImplException </see> and 
    /// <see c = "CapeLimitedImplException ">USEPA_Simulation_PlugIns.CapeLimitedImplException </see>
    /// derive from this class.
    /// </remarks>
    [Serializable]
        ...
        USEPA_Simulation_PlugIns.ECapeBadInvOrder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the CapeBadInvOrderException class with a specified error message, a reference to the inner exception, and the name of the operation raising the exception that is the cause of this exception.
        /// </summary>
        /// <remarks>
        /// <para>The content of the message parameter is intended to be understood by 
        /// humans. The caller of this constructor is required to ensure that this string 
    ...
    [System.Runtime.InteropServices.ClassInterface(System.Runtime.InteropServices.ClassInterfaceType.None)]
    public class COMUSEPA_Simulation_PlugInsExceptionWrapper : CapeUserException
    {
        ...
        /// <summary>
        /// Creates a new instance of the COMUSEPA_Simulation_PlugInsExceptionWrapper class.
        /// </summary>
        /// <remarks>
        ...
        public COMUSEPA_Simulation_PlugInsExceptionWrapper(String message, Object exceptionObject, int HRESULT, System.Exception inner)
            : base(message, inner)
        {
            this.HResult = HRESULT;
            if (exceptionObject is USEPA_Simulation_PlugIns.ECapeRoot)
            {
                m_name = String.Concat("CAPE-OPEN Error: ", ((USEPA_Simulation_PlugIns.ECapeRoot)exceptionObject).Name);
            }

            if (exceptionObject is USEPA_Simulation_PlugIns.ECapeUser)
            {
                USEPA_Simulation_PlugIns.ECapeUser user = (USEPA_Simulation_PlugIns.ECapeUser)exceptionObject;
    ...
    /// error condition as a .Net-based exception using the <see c = "COMUSEPA_Simulation_PlugInsExceptionWrapper">COMUSEPA_Simulation_PlugInsExceptionWrapper</see> 
    /// wrapper class.</para>
    /// <para>The CAPE-OPEN error handling process chose not to use the COM IErrorInfo API due to
    /// limitation of the Visual Basic programming language at the time that the error
    /// handling protocols were developed. Instead, the CAPE-OPEN error handling protocol 
    ...
    /// and sometimes the <see c = "ECapeUnknown">ECapeUnknown</see> error interfaces.</para>
    /// </remarks>
    /// <see c = "COMUSEPA_Simulation_PlugInsExceptionWrapper">COMUSEPA_Simulation_PlugInsExceptionWrapper</see> 
    [System.Runtime.InteropServices.ComVisible(false)]
    public class COMExceptionHandler
    {

        /// <summary>
        /// Creates and returns a new instance of the COMUSEPA_Simulation_PlugInsExceptionWrapper class.
        /// </summary>
        /// <remarks>
        /// <para>Creates a .Net based exception wrapper for COM-based CAPE-OPEN componets to 
        ...
        public static System.Exception ExceptionForHRESULT(Object exceptionObject, System.Exception inner)
        {
            ...
            COMUSEPA_Simulation_PlugInsExceptionWrapper exception = new COMUSEPA_Simulation_PlugInsExceptionWrapper(message, exceptionObject, HRESULT, inner);
            switch (HRESULT)
            {
                ...
                case unchecked((int)0x80040505)://ECapeBadArgumentHR = 0x80040505 ,
                    return new CapeBadArgumentException(message, exception, ((USEPA_Simulation_PlugIns.ECapeBadArgument)exception).position);
                case unchecked((int)0x80040506)://ECapeInvalidArgumentHR = 0x80040506 ,
                    return new CapeInvalidArgumentException(message, exception, ((USEPA_Simulation_PlugIns.ECapeBadArgument)exception).position);
                case unchecked((int)0x80040507)://ECapeOutOfBoundsHR = 0x80040507 
                    {
                        System.Exception p_Ex = (System.Exception)(exception);
                        if (exception is USEPA_Simulation_PlugIns.ECapeBoundaries)
                        {
                            USEPA_Simulation_PlugIns.ECapeBoundaries p_Ex1 = (USEPA_Simulation_PlugIns.ECapeBoundaries)(exception);
                            if (exception is USEPA_Simulation_PlugIns.ECapeBadArgument)
                            {
                                USEPA_Simulation_PlugIns.ECapeBadArgument p_Ex2 = (USEPA_Simulation_PlugIns.ECapeBadArgument)(exception);
                ...
                case unchecked((int)0x80040511)://ECapeBadInvOrderHR = 0x80040511 
                    {
                        ...
                        if (exception is USEPA_Simulation_PlugIns.ECapeBadInvOrder)
                        {
                            USEPA_Simulation_PlugIns.ECapeBadInvOrder p_Ex = (USEPA_Simulation_PlugIns.ECapeBadInvOrder)(exception);
                ...
                case unchecked((int)0x80040515)://ECapePersistenceNotFoundHR = 0x80040515
                    return new CapePersistenceNotFoundException(message, exception, ((USEPA_Simulation_PlugIns.ECapePersistenceNotFound)exception).itemName);
