...
namespace USEPA_Simulation_PlugIns
{
    ...
    public class BooleanParameter : CapeParameter,
        ...
        CAPEOPEN.ICapeBooleanParameterSpec,
        System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <remarks>
        /// This value uses the System.Object data type for compatibility with COM-based CAPE-OPEN. The value is marshaled 
        ...
        /// <param name = "value">Sets the initial and default value of the parameter.</param>
        /// <param name = "mode">Sets the CapeParamMode mode of the parameter.</param>
        public BooleanParameter(String name, bool value, CAPEOPEN.CapeParamMode mode)
        ...
        /// <param name = "mode">Sets the CapeParamMode mode of the parameter.</param>
        public BooleanParameter(String name, String description, bool value, bool defaultValue, CAPEOPEN.CapeParamMode mode)
        ...
        public override bool Validate(ref String message)
        {
            ...
            m_ValStatus = CAPEOPEN.CapeValidationStatus.CAPE_VALID;
            ParameterValidatedEventArgs args = new ParameterValidatedEventArgs(this.ComponentName, message, CAPEOPEN.CapeValidationStatus.CAPE_VALID, CAPEOPEN.CapeValidationStatus.CAPE_VALID);
        ...
        public override CAPEOPEN.CapeParamType Type
        {
            get
            {
                return CAPEOPEN.CapeParamType.CAPE_BOOLEAN;
            }
        }
    ...
    class BooleanParameterWrapper : CapeParameter,
        ...
        System.ComponentModel.INotifyPropertyChanged
    {
        private CAPEOPEN.ICapeParameter m_Parameter;
        ...
        public BooleanParameterWrapper(CAPEOPEN.ICapeParameter parameter)
        ...
        public override bool Validate(ref String message)
        {
            CAPEOPEN.CapeValidationStatus valid = m_Parameter.ValStatus;
        ...
        public bool DefaultValue
        {
            get
            {
                return ((CAPEOPEN.ICapeBooleanParameterSpec)m_Parameter.Specification).DefaultValue;
            }
            set
            {
            }
        ...
        public bool Validate(bool value, ref String message)
        {
            return ((CAPEOPEN.ICapeBooleanParameterSpec)m_Parameter.Specification).Validate(value, message);
        }
    };
}
