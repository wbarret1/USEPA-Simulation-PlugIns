...
namespace USEPA_Simulation_PlugIns
{
    ...
    class ParameterTypeConverter : System.ComponentModel.ExpandableObjectConverter
    {
        ...
        {
            if (typeof(USEPA_Simulation_PlugIns.ICapeParameter).IsAssignableFrom(destinationType))
                return true;
            if (typeof(USEPA_Simulation_PlugIns.ICapeIdentification).IsAssignableFrom(destinationType))
                return true;
    ...
    /// <remarks>
    /// <para>
    /// Aspen Plus(TM) does not use the <see cref = "USEPA_Simulation_PlugIns.ICapeParameterSpec.Dimensionality">ICapeParameterSpec.Dimensionality</see> method. Instead a parameter
