...
namespace USEPA_Simulation_PlugIns
{
    ...
    [USEPA_Simulation_PlugIns.CapeName("WAR Add-In")]
    [USEPA_Simulation_PlugIns.CapeAbout("Waste Reduction Algorithm Add-in")]
    [USEPA_Simulation_PlugIns.CapeDescription("Waste Reduction Algorithm Add-in")]
    ...
    public class WARAddIn : CapeObjectBase
    {
        ...
        public override System.Windows.Forms.DialogResult Edit()
        {
            try
            {
                USEPA_Simulation_PlugIns.WARalgorithm war = new WARalgorithm(this.warDataTable, this.FlowsheetMonitoring);
