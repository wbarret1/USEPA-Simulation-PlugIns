...
namespace USEPA_Simulation_PlugIns
{
    ...
    class ParameterCollectionTypeConverter : System.ComponentModel.ExpandableObjectConverter
    {
        ...
        {
            if ((typeof(System.String)).IsAssignableFrom(destinationType) && (typeof(CAPEOPEN.ICapeIdentification).IsAssignableFrom(value.GetType())))
            {
    ...
    public class ParameterCollection :
         System.ComponentModel.BindingList<CAPEOPEN.ICapeParameter>,
        CAPEOPEN.ICapeCollection,
        ...
        CAPEOPEN.ICapeIdentification
    {
        ...
        int CAPEOPEN.ICapeCollection.Count()
        {
        ...
        Object CAPEOPEN.ICapeCollection.Item(Object index)
        {
            ...
            if ((indexType == typeof(String)))
            {
                ...
                {
                    CAPEOPEN.ICapeIdentification p_Id = (CAPEOPEN.ICapeIdentification)(this.Items[i]);
    ...
    class ParameterCollectionPropertyDescriptor : System.ComponentModel.PropertyDescriptor
    {
        ...
        public override String DisplayName
        {
            get
            {
                return ((CAPEOPEN.ICapeIdentification)this.collection[index]).ComponentName;
            }
        }
        ...
        public override String Description
        {
            get
            {
                return ((CAPEOPEN.ICapeIdentification)this.collection[index]).ComponentDescription;
            }
        }
