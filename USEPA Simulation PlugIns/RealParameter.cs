...
namespace USEPA_Simulation_PlugIns
{
    ...
    class UnitConverter : System.ComponentModel.StringConverter
    {
        ...
        {
            USEPA_Simulation_PlugIns.RealParameter unit = (USEPA_Simulation_PlugIns.RealParameter)context.Instance;
            string[] retVal = USEPA_Simulation_PlugIns.CDimensions.UnitsMatchingCategory(USEPA_Simulation_PlugIns.CDimensions.UnitCategory(unit.Unit));
    ...
    class RealParameterTypeConverter : ParameterTypeConverter
    {
        ...
        {
            if (typeof(USEPA_Simulation_PlugIns.RealParameter).IsAssignableFrom(destinationType))
                return true;
            return base.CanConvertTo(context, destinationType);
        }
        public override Object ConvertTo(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, Object value, System.Type destinationType)
        {
            if ((typeof(System.String).IsAssignableFrom(destinationType)) && typeof(USEPA_Simulation_PlugIns.RealParameter).IsAssignableFrom(value.GetType()))
            {
                USEPA_Simulation_PlugIns.RealParameter param = (USEPA_Simulation_PlugIns.RealParameter)value;
        ...
        IATCapeXRealParameterSpec
    {
        ...
        public double ConvertTo(String desiredUnit)
        {
            ...
            {
                String[] units = USEPA_Simulation_PlugIns.CDimensions.Units;
                for (int i = 0; i < units.Length; i++)
                {
                    if (units[i] == desiredUnit)
                    {
                        Factor1 = USEPA_Simulation_PlugIns.CDimensions.ConverionsTimes(desiredUnit);
                        Factor2 = USEPA_Simulation_PlugIns.CDimensions.ConverionsPlus(desiredUnit);
                        bUnitExisting = true;
                        break;
                    }
                }
        ...
        public double ConvertToSI(double value, String unit)
        {
            ...
            if ((unit != null) || (unit == String.Empty))
            {
                ...
                for (int i = 0; i < units.Length; i++)
                {
                    if (units[i] == unit)
                    {
                        Factor1 = USEPA_Simulation_PlugIns.CDimensions.ConverionsTimes(unit);
                        Factor2 = USEPA_Simulation_PlugIns.CDimensions.ConverionsPlus(unit);
                        bUnitExisting = true;
                        break;
                    }
                }
        ...
        public String Unit
        {
            ...
            {
                m_unit = value;
                //m_Category = USEPA_Simulation_PlugIns.CDimensions.UnitCategory(m_unit); 
        ...
        public double DimensionedDefaultValue
        {
            get
            {
                ...
                for (int i = 0; i < units.Length; i++)
                {
                    ...
                    {
                        Factor1 = USEPA_Simulation_PlugIns.CDimensions.ConverionsTimes(this.Unit);
                        Factor2 = USEPA_Simulation_PlugIns.CDimensions.ConverionsPlus(this.Unit);
                        bUnitExisting = true;
                        break;
                    }
                }
        ...
        public String SIUnit
        {
            get
            {
                return USEPA_Simulation_PlugIns.CDimensions.FindSIUnit(m_unit);
            }
        }
        /// <summary>
        ...
        String IATCapeXRealParameterSpec.DisplayUnits
        {
            get
            {
                return USEPA_Simulation_PlugIns.CDimensions.AspenUnit(m_unit);
            }
        }
