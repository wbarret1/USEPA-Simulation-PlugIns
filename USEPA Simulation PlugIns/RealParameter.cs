...
namespace USEPA_Simulation_PlugIns
{
    ...
    public class RealParameter : CapeParameter,
        ...
        //CAPEOPEN.ICapeRealParameterSpecCOM,
        IATCapeXRealParameterSpec
    {
        ...
        public RealParameter(System.String name, System.String description, double value, double defaultValue, double lowerBound, double upperBound, CAPEOPEN.CapeParamMode mode, string unit)
        ...
        /// <param name = "mode">Sets the CapeParamMode mode of the parameter.</param>
        /// <param name = "unit">Use to Set the dimensionality of the parameter.</param>
        public RealParameter(System.String name, System.String description, double value, double defaultValue, CAPEOPEN.CapeParamMode mode, string unit)
            : base(name, description, mode)
        {
            m_value = value;
            m_DefaultValue = defaultValue;
        ...
        public RealParameter(String name, double value, double defaultValue, String unit)
            : base(name, "", CAPEOPEN.CapeParamMode.CAPE_INPUT_OUTPUT)
        {
            m_value = value;
            m_DefaultValue = defaultValue;
            m_ValStatus = CAPEOPEN.CapeValidationStatus.CAPE_VALID;
        ...
        /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
        /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognized Compound identifier or UNDEFINED for the props argument.</exception>
        bool CAPEOPEN.ICapeRealParameterSpec.Validate(double value, ref String message)
        {
        ...
        public override bool Validate(ref String message)
        {
            ...
            ParameterValidatedEventArgs args = new ParameterValidatedEventArgs(this.ComponentName, message, m_ValStatus, CAPEOPEN.CapeValidationStatus.CAPE_VALID);            
            bool retval = true;
        ...
        /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed.</exception>
        [System.ComponentModel.BrowsableAttribute(false)]
        double CAPEOPEN.ICapeRealParameterSpec.DefaultValue
        {
            get
            {
        ...
        /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognized Compound identifier or UNDEFINED for the props argument.</exception>
        [System.ComponentModel.BrowsableAttribute(false)]
        double CAPEOPEN.ICapeRealParameterSpec.LowerBound
        {
            get
            {
        ...
        /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognized Compound identifier or UNDEFINED for the props argument.</exception>
        [System.ComponentModel.BrowsableAttribute(false)]
        double CAPEOPEN.ICapeRealParameterSpec.UpperBound
        {
            get
            {
