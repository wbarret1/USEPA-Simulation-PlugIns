...
{ 
    ...
    class ArrayParameterWrapper : CapeParameter,
        ...
        CAPEOPEN.ICapeArrayParameterSpec
    {
        ...
        public ArrayParameterWrapper(CAPEOPEN.ICapeParameter parameter)
        ...
        /// </summary>        
        /// <remarks>
        /// The wrapped parameter validates itself against its internal validation criteria.
        /// </remarks>
        /// <returns>
        ...
        public override CAPEOPEN.CapeParamType Type
        {
            get
            {
                return CAPEOPEN.CapeParamType.CAPE_ARRAY;
            }
        }
        ...
        dynamic CAPEOPEN.ICapeArrayParameterSpec.ItemsSpecifications
        {
            get
            {
                return (object[])((CAPEOPEN.ICapeArrayParameterSpec)m_parameter.Specification).ItemsSpecifications;
            }
        }
        ...
        int CAPEOPEN.ICapeArrayParameterSpec.NumDimensions
        {
            get
            {
                return ((CAPEOPEN.ICapeArrayParameterSpec)m_parameter.Specification).NumDimensions;
            }
        }
        ...
        /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed.</exception>
        [System.ComponentModel.Category("Parameter Specification")]
        dynamic CAPEOPEN.ICapeArrayParameterSpec.Size
        {
            get
            {
                return (int[])((CAPEOPEN.ICapeArrayParameterSpec)m_parameter.Specification).Size;
            }
        }
        ...
        /// <exception cref ="ECapeUnknown">The error to be raised when other error(s),  specified for this operation, are not suitable.</exception>
        /// <exception cref = "ECapeInvalidArgument">To be used when an invalid argument value is passed, for example, an unrecognized Compound identifier or UNDEFINED for the props argument.</exception>
        object CAPEOPEN.ICapeArrayParameterSpec.Validate(object value, ref object messages)
        {
            return ((CAPEOPEN.ICapeArrayParameterSpec)m_parameter.Specification).Validate(value, ref messages);
        }
    };
}
