        ...
        /*        // IPersist
                ...
                void IPersistStream.Load(System.Runtime.InteropServices.ComTypes.IStream pStm)
                {
                    ...
                    try
                    {
                        ...
                        domain.AssemblyResolve += new ResolveEventHandler(USEPA_Simulation_PlugIns.CapeUnitBase.MyResolveEventHandler);
                ...
                void IPersistStreamInit.InitNew()
                {
                    if (m_Loaded)
                    {
                        USEPA_Simulation_PlugIns.CapeUnexpectedException p_Ex = new CapeUnexpectedException("The object has already been initialized with IPersistStreamInit.Load.");
                        throw p_Ex;
                    }
                }
        */
        ...
        virtual public String ProduceReport()
        {
            ...
            USEPA_Simulation_PlugIns.CapeValidationStatus status = this.ValStatus;
            ...
            for (int i = 0; i < this.Parameters.Count; i++)
            {
                ...
                USEPA_Simulation_PlugIns.ICapeParameterSpec p_Spec = (ICapeParameterSpec)p_Param.Specification;
                ...
                {
                    retVal = String.Concat(retVal, "     Value: ", p_Param.value.ToString(), Environment.NewLine);
                    USEPA_Simulation_PlugIns.ICapeIntegerParameterSpec p_IntParam = (ICapeIntegerParameterSpec)p_Spec;
                ...
                {
                    retVal = String.Concat(retVal, "     Value: ", p_Param.value.ToString(), Environment.NewLine);
                    USEPA_Simulation_PlugIns.ICapeBooleanParameterSpec p_Bool = (ICapeBooleanParameterSpec)p_Spec;
                ...
                {
                    retVal = String.Concat(retVal, "     Value: ", p_Param.value.ToString(), Environment.NewLine);
                    USEPA_Simulation_PlugIns.ICapeOptionParameterSpec p_Opt = (ICapeOptionParameterSpec)p_Spec;
