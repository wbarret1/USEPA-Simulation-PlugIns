...
namespace USEPA_Simulation_PlugIns
{
        ...
        ICapeThermoPropertyRoutine
    {
        ...
        [NonSerialized]
        private USEPA_Simulation_PlugIns.ICapeThermoMaterialCOM p_IMatObj;
        [NonSerialized]
        private USEPA_Simulation_PlugIns.ICapeThermoCompoundsCOM p_ICompounds;
        [NonSerialized]
        private USEPA_Simulation_PlugIns.ICapeThermoPhasesCOM p_IPhases;
        [NonSerialized]
        private USEPA_Simulation_PlugIns.ICapeThermoUniversalConstantCOM p_IUniversalConstant;
        [NonSerialized]
        private USEPA_Simulation_PlugIns.ICapeThermoPropertyRoutineCOM p_IPropertyRoutine;
        [NonSerialized]
        private USEPA_Simulation_PlugIns.ICapeThermoEquilibriumRoutineCOM p_IEquilibriumRoutine;
        ...
        public MaterialObjectWrapper(Object materialObject)
        {
            ...
            {
                p_MaterialObject = (USEPA_Simulation_PlugIns.ICapeThermoMaterialObjectCOM)materialObject;
                Thermo10 = true;
            }
            p_IMatObj = null;
        ...
        String[] ICapeThermoMaterialObject.ComponentIds
        {
            get
            {
                ...
                {
                    throw USEPA_Simulation_PlugIns.COMExceptionHandler.ExceptionForHRESULT(p_MaterialObject, p_Ex);
                }
            }
        }
        ...
        /// use of the USEPA_Simulation_PlugIns interfaces. It returns the most frequently requested 
        ...
        /// <exception cref = "ECapeUnknown">The error to be raised when 
        /// other error(s), specified for this operation, are not suitable.</exception>
        void ICapeThermoMaterial.GetPresentPhases(ref String[] phaseLabels, ref USEPA_Simulation_PlugIns.CapePhaseStatus[] phaseStatus)
        {
            Object obj1 = null;
            Object obj2 = null;
            p_IMatObj.GetPresentPhases(ref obj1, ref obj2);
            phaseLabels = (String[])obj1;
            phaseStatus = new USEPA_Simulation_PlugIns.CapePhaseStatus[phaseLabels.Length];
            int[] values = (int[])obj2;
            for (int i = 0; i < phaseStatus.Length; i++)
            {
                if (values[i] == 0) phaseStatus[i] = USEPA_Simulation_PlugIns.CapePhaseStatus.CAPE_UNKNOWNPHASESTATUS;
                if (values[i] == 1) phaseStatus[i] = USEPA_Simulation_PlugIns.CapePhaseStatus.CAPE_ATEQUILIBRIUM;
                if (values[i] == 2) phaseStatus[i] = USEPA_Simulation_PlugIns.CapePhaseStatus.CAPE_ESTIMATES;
            }
        }
        ...
        /// <exception cref = "ECapeUnknown">The error to be raised when 
        /// other error(s), specified for this operation, are not suitable.</exception>
        void ICapeThermoMaterial.SetPresentPhases(String[] phaseLabels, USEPA_Simulation_PlugIns.CapePhaseStatus[] phaseStatus)
        {
            int[] obj1 = new int[phaseStatus.Length];
            for (int i = 0; i < obj1.Length; i++)
            {
                if (phaseStatus[i] == USEPA_Simulation_PlugIns.CapePhaseStatus.CAPE_UNKNOWNPHASESTATUS) obj1[i] = 0;
                if (phaseStatus[i] == USEPA_Simulation_PlugIns.CapePhaseStatus.CAPE_ATEQUILIBRIUM) obj1[i] = 1;
                if (phaseStatus[i] == USEPA_Simulation_PlugIns.CapePhaseStatus.CAPE_ESTIMATES) obj1[i] = 2;
            }
