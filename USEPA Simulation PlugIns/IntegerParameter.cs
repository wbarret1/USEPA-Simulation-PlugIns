...
namespace USEPA_Simulation_PlugIns
{
    ...
    /// <summary>
    /// Indicates that the specification of an integer-valued parameter has been changed.
    /// </summary>
    /// <remarks>
        ...
        System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para>The default value is set to the initial value of the parameter. The upper
        ...
        public IntegerParameter(String name, int value, CAPEOPEN.CapeParamMode mode)
        ...
        /// <summary>
        /// Creates a new instance of the integer-valued parameter class using the values entered. 
        /// </summary>
        /// <remarks>
        ...
        /// <param name = "mode">Sets the CapeParamMode mode of the parameter.</param>
        public IntegerParameter(String name, String description, int value, int defaultValue, int minValue, int maxValue, CAPEOPEN.CapeParamMode mode)
