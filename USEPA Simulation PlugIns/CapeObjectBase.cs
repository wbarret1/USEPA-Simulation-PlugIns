...
namespace USEPA_Simulation_PlugIns
{
        ...
        CAPEOPEN.ECapeRoot
    {
        ...
        /// </summary>
        /// <remarks>
        /// The simulation context provides access to the PME, enabling the PMC to access the PME's COSE interfaces <see cref ="ICapeDiagnostic"/>, 
        /// <see cref ="ICapeMaterialTemplateSystem"/> and <see cref ="ICapeCOSEUtilities"/>.
        /// </remarks>
        [NonSerialized]
        private CAPEOPEN.ICapeSimulationContext m_SimulationContext;
        ...
        /// to show the editor, this method will be called to edit the unit. Overridden classes should
        ...
        int CAPEOPEN.ICapeUtilities.Edit()
        {
            try
            {
        ...
        Object CAPEOPEN.ICapeUtilities.parameters
        {
            get
            {
                return m_Parameters;
        ...
        /// <exception cref = "ECapeNoImpl">ECapeNoImpl</exception>
        [System.ComponentModel.BrowsableAttribute(false)]
        Object CAPEOPEN.ICapeUtilities.simulationContext
        {
            set
            {
                if (value is CAPEOPEN.ICapeSimulationContext)
                    m_SimulationContext = (CAPEOPEN.ICapeSimulationContext)value;
            }
        }
        ...
        /// <exception cref = "ECapeOutOfResources">ECapeOutOfResources</exception>
        /// <exception cref = "ECapeBadInvOrder">ECapeBadInvOrder</exception>
        void CAPEOPEN.ICapeUtilities.Initialize()
        {
            this.Initialize();
        }
        ...
        override public object Clone()
        {
            ...
            if (retVal.GetType().IsAssignableFrom(typeof(CAPEOPEN.ICapeSimulationContext)))
                retVal.SimulationContext = (CAPEOPEN.ICapeSimulationContext)this.m_SimulationContext;
            return retVal;
        }
        ...
        /// <exception cref = "ECapeNoImpl">ECapeNoImpl</exception>
        [System.ComponentModel.BrowsableAttribute(false)]
        public CAPEOPEN.ICapeSimulationContext SimulationContext
        {
            get
            {
        ...
        /// Use the exception object as the argument to this function. As a result, the information in the exception will be exposed using the CAPE-OPEN 
        ...
        /// </value>
        [System.ComponentModel.BrowsableAttribute(false)]
        String CAPEOPEN.ECapeRoot.name
        {
            get
            {
                if (p_Exception is CAPEOPEN.ECapeRoot) return ((CAPEOPEN.ECapeRoot)p_Exception).name;
                return "";
            }
        }
        ...
        /// </value>
        [System.ComponentModel.BrowsableAttribute(false)]
        int CAPEOPEN.ECapeUser.code
        {
            get
            {
                return ((CAPEOPEN.ECapeUser)p_Exception).code;
            }
        }
        ...
        /// </value>
        [System.ComponentModel.BrowsableAttribute(false)]
        String CAPEOPEN.ECapeUser.description
        {
            get
            {
                return ((CAPEOPEN.ECapeUser)p_Exception).description;
            }
        }
        ...
        [System.ComponentModel.BrowsableAttribute(false)]
        String CAPEOPEN.ECapeUser.scope
        {
            get
            {
                return ((CAPEOPEN.ECapeUser)p_Exception).scope;
            }
        }
        ...
        [System.ComponentModel.BrowsableAttribute(false)]
        String CAPEOPEN.ECapeUser.interfaceName
        {
            get
            {
                return ((CAPEOPEN.ECapeUser)p_Exception).interfaceName;
            }
        }
        ...
        [System.ComponentModel.BrowsableAttribute(false)]
        String CAPEOPEN.ECapeUser.operation
        {
            get
            {
                return ((CAPEOPEN.ECapeUser)p_Exception).operation;
            }
        }
        ...
        /// <value>The URL.</value>
        [System.ComponentModel.BrowsableAttribute(false)]
        String CAPEOPEN.ECapeUser.moreInfo
        {
            get
            {
                return ((CAPEOPEN.ECapeUser)p_Exception).moreInfo;
            }
        }
        ...
        /// The implementation should ensure that the string is written out to a dialog box or 
        ...
        public void PopUpMessage(System.String message)
        {
            if (m_SimulationContext != null)
            {
                if (m_SimulationContext is CAPEOPEN.ICapeDiagnostic)
                {
                    ((CAPEOPEN.ICapeDiagnostic)this.m_SimulationContext).PopUpMessage(message);
                }
            }
        }
        /// <summary>
        ...
        public void LogMessage(System.String message)
        {
            if (m_SimulationContext != null)
            {
                if (m_SimulationContext is CAPEOPEN.ICapeDiagnostic)
                {
                    ((CAPEOPEN.ICapeDiagnostic)this.m_SimulationContext).LogMessage(message);
                }
            }
        }
    };
