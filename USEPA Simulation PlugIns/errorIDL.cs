...
namespace USEPA_Simulation_PlugIns {
	...
	{	
		...
		/// For example USEPA_Simulation_PlugIns.Common.Identification.
		/// </remarks>
		/// <value>The source of the error.</value>
		[System.Runtime.InteropServices.DispIdAttribute(3), System.ComponentModel.DescriptionAttribute("The scope of the error. The list of packages where the error occurs separated by '.'. For example USEPA_Simulation_PlugIns.Common.Identification.")] 
		String scope
		{
			get;
		}
