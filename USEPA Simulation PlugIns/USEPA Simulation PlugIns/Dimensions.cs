...
namespace USEPA_Simulation_PlugIns
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>The unit of measure can be either an System International (SI) or customary unit. Each unit is assigned to a 
    ...
    static class CDimensions
    {
        ...
        static CDimensions()
        {
            ...
            System.IO.Stream resStream = myAssembly.GetManifestResourceStream("USEPA_Simulation_PlugIns.Resources.units.xml.resources");
            ...
            resStream = myAssembly.GetManifestResourceStream("USEPA_Simulation_PlugIns.Resources.unitCategories.xml.resources");
        ...
        public static String UnitCategory(String unit)
        {
            ...
            //{
            //    USEPA_Simulation_PlugIns.unitCategory current = (USEPA_Simulation_PlugIns.unitCategory)unitCategories[i];
            //    if (current.Name == unit)
            //    {
        ...
        //    for (int i = 0; i < units.Count; i++)
        //    {
        //        USEPA_Simulation_PlugIns.unit current = (USEPA_Simulation_PlugIns.unit)units[i];
        //        if (current.Name == unit)
        //        {
        ...
        //        }
        //    }
        //    if (!found) throw new USEPA_Simulation_PlugIns.CapeBadArgumentException(String.Concat("Unit: ", unit, " was not found"), 1);
        //}
