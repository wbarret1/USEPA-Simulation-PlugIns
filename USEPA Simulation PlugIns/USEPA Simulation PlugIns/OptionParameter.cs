...
namespace USEPA_Simulation_PlugIns
{
        ...
        System.ComponentModel.INotifyPropertyChanged
    {
        ...
        {
            m_value = value;
            this.Mode = USEPA_Simulation_PlugIns.CapeParamMode.CAPE_INPUT_OUTPUT;
            m_DefaultValue = value;
            m_ValStatus = USEPA_Simulation_PlugIns.CapeValidationStatus.CAPE_VALID;
        }
        /// <summary>
        ...
        public override bool Validate(ref String message)
        {
            ...
            if (m_Restricted)
            {
                ...
                if (!inList)
                {
                    ...
                    args = new ParameterValidatedEventArgs(this.ComponentName, message, m_ValStatus, USEPA_Simulation_PlugIns.CapeValidationStatus.CAPE_INVALID);
                    m_ValStatus = USEPA_Simulation_PlugIns.CapeValidationStatus.CAPE_INVALID;
            ...
            args = new ParameterValidatedEventArgs(this.ComponentName, message, m_ValStatus, USEPA_Simulation_PlugIns.CapeValidationStatus.CAPE_VALID);
            m_ValStatus = USEPA_Simulation_PlugIns.CapeValidationStatus.CAPE_VALID;
            NotifyPropertyChanged("ValStatus");
            OnParameterValidated(args);
            return true;
