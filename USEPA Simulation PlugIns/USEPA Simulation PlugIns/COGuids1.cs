...
namespace USEPA_Simulation_PlugIns
{
    ...
    */
    ...
    // This file was developed/modified by JEAN-PIERRE BELAUD for CO-LaN organization - March 2003

    class COGuids
    {

        // CAPE-OPEN Category
        public const String USEPA_Simulation_PlugInsComponent_CATID = "{678c09a1-7d66-11d2-a67d-00105a42887f}";
        ...
        public const String USEPA_Simulation_PlugInsReactionsPackageManager_CATID = "{678c09aa-0100-11d2-a67d-00105a42887f}";
        // CAPE-OPEN Standalone Reactions Package
        public const String USEPA_Simulation_PlugInsReactionsPackage_CATID = "{678c09ab-0100-11d2-a67d-00105a42887f}";
