...
namespace USEPA_Simulation_PlugIns
{
    ...
    class ParameterCollectionTypeConverter : System.ComponentModel.ExpandableObjectConverter
    {
        ...
        {
            if ((typeof(System.String)).IsAssignableFrom(destinationType) && (typeof(USEPA_Simulation_PlugIns.ICapeIdentification).IsAssignableFrom(value.GetType())))
            {
    ...
    /// ICustomTypeDescriptor to provide dynamic information about the collection.</para>
    /// <para>
    ...
    public class ParameterCollection :
         System.ComponentModel.BindingList<USEPA_Simulation_PlugIns.ICapeParameter>,
        USEPA_Simulation_PlugIns.ICapeCollection,
        System.ComponentModel.ICustomTypeDescriptor,
        ICloneable,
        USEPA_Simulation_PlugIns.ICapeIdentification
    {
        ...
        int USEPA_Simulation_PlugIns.ICapeCollection.Count()
        {
        ...
        Object USEPA_Simulation_PlugIns.ICapeCollection.Item(Object index)
        {
            ...
            if ((indexType == typeof(String)))
            {
                ...
                {
                    USEPA_Simulation_PlugIns.ICapeIdentification p_Id = (USEPA_Simulation_PlugIns.ICapeIdentification)(this.Items[i]);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref = "ParameterCollection"/> collection class.
        /// </summary>
    ...
    //    {
    //        m_types = new Type[4];
    //        m_types[0] = typeof(USEPA_Simulation_PlugIns.BooleanParameter);
    //        m_types[1] = typeof(USEPA_Simulation_PlugIns.IntegerParameter);
    //        m_types[2] = typeof(USEPA_Simulation_PlugIns.OptionParameter);
    //        m_types[3] = typeof(USEPA_Simulation_PlugIns.RealParameter);
    //    }
    ...
    class ParameterCollectionPropertyDescriptor : System.ComponentModel.PropertyDescriptor
    {
        ...
        public override String DisplayName
        {
            get
            {
                return ((USEPA_Simulation_PlugIns.ICapeIdentification)this.collection[index]).ComponentName;
            }
        }
        ...
        public override String Description
        {
            get
            {
                return ((USEPA_Simulation_PlugIns.ICapeIdentification)this.collection[index]).ComponentDescription;
            }
        }
