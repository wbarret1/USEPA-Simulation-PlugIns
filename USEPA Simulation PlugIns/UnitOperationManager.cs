...
namespace USEPA_Simulation_PlugIns
{
    ...
    /// the unit. Further, it creates and uses a "USEPA_Simulation_PlugIns Objects" directory located in the current user's 
    ...
    /// placed in a sudirectory under the %Program Files%\CommonFiles\USEPA_Simulation_PlugIns Objects directory.
    /// </para>
    /// </remarks>
    [Serializable]
    ...
    [USEPA_Simulation_PlugIns.CapeVersionAttribute("1.0")]
    [USEPA_Simulation_PlugIns.CapeVendorURLAttribute("http:\\www.epa.gov")]
    [USEPA_Simulation_PlugIns.CapeHelpURLAttribute("http:\\www.epa.gov")]
    [USEPA_Simulation_PlugIns.CapeAboutAttribute("US Environmental Protection Agency\nCincinnati, Ohio")]
        ...
        System.Runtime.Serialization.ISerializable
    {
        ...
        public UnitOperationWrapper(System.Guid CLSID)
        {
            ...
            if (test == null)
            {
                throwException(new USEPA_Simulation_PlugIns.CapeInvalidArgumentException(string.Concat(Type.GetTypeFromCLSID(m_CLSID).ToString(), "is not a valid ICapeUnit unit operation"), 1));
            }
        }
