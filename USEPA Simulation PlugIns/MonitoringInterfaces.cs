...
namespace USEPA_Simulation_PlugIns
{
	...
	*****************************************/
	...
	public interface ICapeFlowsheetMonitoring
	{
		...
		USEPA_Simulation_PlugIns.CapeSolutionStatus SolutionStatus 
		{
			get;
		}
		...
		/// </summary>
		/// <remarks>
        /// Gets the <see cref = "CapeValidationStatus"/> of the flowsheet.
		/// </remarks>
		/// <returns>
        /// the <see cref = "CapeValidationStatus"/> of the flowsheet.
		/// </returns>
		[System.Runtime.InteropServices.DispIdAttribute(4)]
		[System.ComponentModel.DescriptionAttribute("Get the flowsheet validation status.")]
        USEPA_Simulation_PlugIns.CapeValidationStatus ValStatus
		{
			get;
		}
	...
	///// </summary>
	///// <remarks>
	///// <para>Monitoring object should implement:</para>
	///// <list type="bullet">
	///// <item>ICapeIdentification</item>
	///// <item>IPersistStream or IPersistStreamInit in case of persistence implementation</item>
	///// <item>ICapeUtilities for parameter collection and Edit and for accepting an ICapeSimulationContext</item>
